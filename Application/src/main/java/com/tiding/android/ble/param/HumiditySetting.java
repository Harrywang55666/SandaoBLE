...
public class HumiditySetting extends Object {
    public static final byte[] REQ_FRAME = ModbusParam.getReadMultiReqFrame(0x1000, 0x19);
    private PeriodSetting[] mPeriodSettings;
    private int mControlMode;

    public static HumiditySetting create(BluetoothLeService service) throws Exception {
        ...
        HumiditySetting result = new HumiditySetting();
    ...
    public void setPeriodSettingItem(PeriodSetting setting, int position, BluetoothLeService service) throws Exception {
        int address = (0x10 << 8) | (byte) ((6 * position) + 1);
    ...
    public void setmControlMode(int mControlMode, BluetoothLeService service) throws Exception {
        byte[] reqFrame = ModbusParam.getWriteSingleReqFrame(0x1000, mControlMode);
